...
public class Shop : MonoBehaviour
{
    ...
    {
        tower.color = new Color32(143, 188, 195, 255);

        for (int i = 2; i < Buttons.transform.childCount; i++)
        {
            Buttons.transform.GetChild(i).transform.GetComponent<Image>().color = new Color32(255, 255, 255, 255);
        }
        Manage_Sounds m = GameObject.Find("Sound Manager").transform.GetComponent<Manage_Sounds>();
    ...
    public void CB()
    {
        ...
        CB_Image.color = new Color32(101, 186, 233, 255);
